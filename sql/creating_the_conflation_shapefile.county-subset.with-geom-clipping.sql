...
DROP TABLE IF EXISTS osm.failing_conflations;

DROP TABLE IF EXISTS scratch.ris_failing_conflations;
CREATE TABLE IF NOT EXISTS scratch.ris_failing_conflations AS
  SELECT
      ogc_fid,
      geom_ids,
      geom_lengths,
...
DROP TABLE IF EXISTS scratch.tmc_failing_conflations;
CREATE TABLE IF NOT EXISTS scratch.tmc_failing_conflations AS
  SELECT
      tmc,
      geom_ids,
      geom_lengths,
